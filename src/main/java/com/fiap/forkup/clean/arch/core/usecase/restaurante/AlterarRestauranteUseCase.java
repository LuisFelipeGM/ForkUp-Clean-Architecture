...
import com.fiap.forkup.clean.arch.core.dto.UpdateRestauranteRequest;
...
public class AlterarRestauranteUseCase {
    ...
    public RestauranteResponseFull execute(final UUID id, final UpdateRestauranteRequest updateRestauranteRequest) {
        ...
        Endereco endereco = enderecoMapper.toDomain(updateRestauranteRequest.endereco());

        restaurante.alterarRestaurante(updateRestauranteRequest.nome(), updateRestauranteRequest.tipoCozinha(), updateRestauranteRequest.horarioFuncionamento(), endereco);
